...
// Ensure downloads directory exists for this site
const downloadsDir = path.join(__dirname, '../public/downloads', WEBSITE_ID);
if (!fs.existsSync(downloadsDir)) {
  fs.mkdirSync(downloadsDir, { recursive: true });
  console.log(`✅ Created downloads directory: public/downloads/${WEBSITE_ID}`);
}
