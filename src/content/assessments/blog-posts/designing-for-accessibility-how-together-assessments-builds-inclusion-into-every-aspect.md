...
title: "Designing for Accessibility: How Together Assessments Builds Inclusion
  Into Every Aspect"
excerpt: Accessibility isn’t an afterthought – it’s a starting point
category: News
tags:
  - font
  - dyslexia
...
Font choice makes a world of difference for readability. Our website offers several research-based typefaces designed to support people with dyslexia, ADHD, and other neurodivergent experiences:

* **Sylexiad Sans**, created by Dr Robert Hillier, is our default font – specifically designed to reduce letter confusion and visual stress.\
  [Download Sylexiad here](https://www.sylexiad.com/)
* **OpenDyslexic**, by Abelardo Gonzalez, is available as an alternative option.\
  [Download OpenDyslexic here](https://opendyslexic.org/)
...
Visitors can adjust the website’s **Accessibility Settings** (found at the top right) to suit their preferences — and preferences are remembered for future visits.

**Available options include:**

* Switch between fonts (**Sylexiad Sans**, **OpenDyslexic**, **Fast Syldexia**)
* Switch between **light**, **dark**, or **system** themes
* Modify **text size** (from small to extra-large)
* Adjust **line height** for easier tracking
* Use a **reading ruler** to highlight the current line
* Activate **text-to-speech** to listen to any text

These settings are especially helpful for neurodivergent adults, whose sensory, processing, and cognitive needs can vary day-to-day. Providing flexible tools supports autonomy, reduces fatigue, and ensures that information remains accessible in the way that works best for each person.
