...
Review date: August 2026 (or sooner if guidance changes)
...
**Stage 1 – Informal Resolution**
 Where appropriate, complaints will be addressed quickly through discussion and mutual agreement.

**Stage 2 – Formal Complaint**

1. **Acknowledgement** within 3 working days.
2. **Investigation** by Adriana Ferrari (or Clinical Supervisor if the complaint is about Adriana Ferrari).
3. **Written Response** issued within 28 calendar days, including:
...
* **Care Quality Commission (CQC)** – while the CQC does not resolve individual complaints, they can be informed about concerns regarding a regulated service.
  Tel: 03000 616161 | Email: enquiries@cqc.org.uk
* **Professional regulator (HCPC)** - for clinical supervisors
* **Local Government & Social Care Ombudsman** (LGSCO) – particularly for publicly funded services
